...
class CleanerBookingSummary extends StatefulWidget {
  final Map<String, dynamic> chef;
  final DateTime startDate;
  final TimeOfDay selectedTime;
  

  const CleanerBookingSummary({
    Key? key,
    required this.chef,
  ...
  @override
  State<CleanerBookingSummary> createState() => _CleanerBookingSummaryState();
}

class _CleanerBookingSummaryState extends State<CleanerBookingSummary> {
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Any special instructions for the domestic helper...",
